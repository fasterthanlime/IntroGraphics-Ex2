...
/*
  ...
  r.point.y = pixel_length*(sample.getPosX() + sample.getOffset().x - 0.5*(m_resolutionX-1.0));
  r.point.z = pixel_length*(sample.getPosY() + sample.getOffset().y - 0.5*(m_resolutionY-1.0));
